...
@Entity
@Table(name="schedule_station_seat_availability")  
public class ScheduleStationSeatAvailability implements Serializable{  
	private static final long serialVersionUID = -6700990760991590860L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	Long schedSeatAvailId;
	@OneToOne  
    @JoinColumn
    VehicleSeat vehicleSeat;
	@OneToOne  
    @JoinColumn
	ScheduleStationSeatSection scheduleStationSeatSection;
	...
	public ScheduleStationSeatSection getScheduleStationSeatSection() {
		return scheduleStationSeatSection;
	}

	public void setScheduleStationSeatSection(
			ScheduleStationSeatSection scheduleStationSeatSection) {
		this.scheduleStationSeatSection = scheduleStationSeatSection;
	}

	public Long getSchedSeatAvailId() {
		return schedSeatAvailId;
	}
